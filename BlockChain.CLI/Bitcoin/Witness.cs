...
{
    public class Witness : AddressBase<NetworkVersion>
    {
        static Witness()
        {
        ...
        public Witness(PublicKey publicKey, NetworkVersion type)
        {
            Key = publicKey;
            Type = type;
        ...
        public Witness(byte[] publicKey, NetworkVersion type)
